...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.12c9a6e2f0047fc8731616519875691964489673f29d4bd7969372a0e9a74b07.js',function(){input.required=false;search();});}
